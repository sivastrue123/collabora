...
const PORT = 5000;
const COLLABORA_URL = process.env.COLLABORA_URL || "https://ez-officeviewer-wopi.azurewebsites.net" ||"http://localhost:9980" ||  "https://ez-officeviewer-app.graycoast-78e47e4a.southindia.azurecontainerapps.io";
...
app.get("/wopi/files/:id", (req, res) => {
  ...
  res.json({
    ...
    PostMessageOrigin: process.env.APP_ORIGIN || "http://localhost:8080",
  });
});
